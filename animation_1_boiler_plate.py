...
pygame.display.set_caption("Autorack Test") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("Autoracks.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 27 # code the number of sprite images your sprite sheet has
